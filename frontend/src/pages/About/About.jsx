...
//       ${isSelected ? 'bg-red-500 text-white border-red-500' : 'bg-white border-gray-200 hover:bg-red-500'}`}
//   >
//     <img
//       src={imgSrc}
//       alt={label}
...
//     <span className='className="text-base font-semibold'>{desc}</span>
//   </div>
// );
...
//   return (
//     <div className="max-w-7xl mx-auto px-4 pt-12 font-montserrat">
//       {/* Hero Section */}
...
//           </p>
//         </div>
//         <div className="bg-pink-300 rounded-lg h-64 w-full">
//           <img src={Main} alt="Shopping experience" className="w-full h-full object-cover rounded-lg" />
//         </div>
//       </div>

//       {/* Stats Section */}
//      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 pt-12 pb-24">
...
//         desc={category.label}
//         isSelected={category.isSelected} // Assuming each category has an isSelected property
...
//       {/* Team Section */}
// <div className="grid sm:grid-cols-1 md:grid-cols-3 lg:gap-8">
//     {teamMembers.map((member, index) => (
//       <div key={index} className="text-center w-full pb-2">
...
//         </div>
//         {/* Name */}
//         <h3 className="font-medium text-lg mb-1 text-left">{member.name}</h3>
//         {/* Role */}
//         <p className="text-gray-600 text-sm mb-3 text-left">{member.role}</p>
//         {/* Social icons - smaller and closer together */}
...
//       {/* Features Section */}
//      <div className="flex justify-center lg:space-x-24 pb-24">
